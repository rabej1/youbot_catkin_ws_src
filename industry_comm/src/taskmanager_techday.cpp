...
int main(int argc, char** argv)
{
	...
	ocp = true;
	srv.request.bring = false;
	srv.request.x_coord_bring = 0;
	srv.request.y_coord_bring = 0;
	srv.request.orientation_bring = 0;
	srv.request.bringback = false;
	srv.request.april_tag_number_bringback = 0;
	srv.request.get = false;
	srv.request.april_tag_number_get = 0;
	srv.request.diceroll = false;
