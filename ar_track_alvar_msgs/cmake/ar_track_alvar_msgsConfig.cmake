...
if("FALSE" STREQUAL "TRUE")
  set(ar_track_alvar_msgs_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-ar-track-alvar-msgs-0.5.1)
  set(ar_track_alvar_msgs_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-ar-track-alvar-msgs-0.5.1/obj-x86_64-linux-gnu/devel)
  ...
  set(ar_track_alvar_msgs_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ar_track_alvar_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Scott Niekum <sniekum@cs.umass.edu>' to fix it.")
    endif()
