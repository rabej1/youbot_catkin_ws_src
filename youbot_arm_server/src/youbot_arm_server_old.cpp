...
#include <youbot_test/YouBotGoalAction.h>
...
protected:
	...
	actionlib::SimpleActionServer<youbot_test::YouBotGoalAction> as_;
	actionlib::SimpleActionClient<control_msgs::FollowJointTrajectoryAction> ac_;
	std::string action_name_;
	youbot_test::YouBotGoalFeedback feedback_;
	youbot_test::YouBotGoalResult result_;
...
public:
	...
	void executeCB(const youbot_test::YouBotGoalGoalConstPtr &gl) {
